        ...
        <div class="col-8">
            ...
            <form action="/member/signup" method="post">
                ...
                <div class="mb-3">
                    ...
                    <input name="email" id="emailInput" required type="email" class="form-control" placeholder="E-mail">
                    <small class="form-text text-muted">이메일 양식에 맞춰 작성해주세요</small>
                </div>
                <div class="mb-3">
                    <label for="pwdInput" class="form-label">패스워드</label>
                    <input name="password" id="pwdInput" required type="password" class="form-control"
