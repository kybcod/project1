...
<form action="/modify" method="post">
    ...
    <div class="mb-3">
        ...
        <input id="inputTitle" class="form-control" type="text" value="${board.title}" name="title" required>
    </div>
    <div class="mb-3">
    ...
    <div class="mb-3">
        ...
        <input id="inputWriter" class="form-control" type="text" value="${board.writer}" name="writer" required>
    </div>
    <div>
        <button>수정</button>
    </div>
